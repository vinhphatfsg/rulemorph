const OPERATOR_CASES: &[OperatorCase] = &[
    ...
    ("abs", r#"["@input.negative", "abs"]"#),
    ("floor", r#"["@input.float", "floor"]"#),
    ("ceil", r#"["@input.float", "ceil"]"#),
    ("trunc", r#"["@input.negative", "trunc"]"#),
    ("sqrt", r#"["@input.base", "sqrt"]"#),
    ("sign", r#"["@input.negative", "sign"]"#),
    ("mod", r#"["@input.n", {"mod": 2}]"#),
    ("pow", r#"["@input.n", {"pow": 2}]"#),
    ("clamp", r#"["@input.n", {"clamp": [0, 10]}]"#),
    ("range", r#"[{"range": [2, 5]}]"#),
