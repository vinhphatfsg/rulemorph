...
pub(super) fn args_len(args: &[Expr], injected: Option<&EvalValue>) -> usize {
    args.len() + usize::from(injected.is_some())
}

pub(super) fn arg_expr_at<'a>(
    index: usize,
    args: &'a [Expr],
    injected: Option<&EvalValue>,
) -> Option<&'a Expr> {
...
pub(super) fn value_to_string(value: &JsonValue, path: &str) -> Result<String, TransformError> {
    match value {
...
pub(super) fn value_as_bool(value: &JsonValue, path: &str) -> Result<bool, TransformError> {
    match value {
