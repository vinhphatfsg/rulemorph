...
pub(super) fn parse_cell_window(range: Option<&str>) -> Result<CellWindow, TransformError> {
...
pub(super) struct ParsedCellRef {
    pub(super) col: usize,
    pub(super) row: Option<usize>,
}

pub(super) fn parse_cell_ref(value: &str) -> Result<ParsedCellRef, TransformError> {
...
pub(super) fn column_letters_to_index(value: &str) -> Result<usize, TransformError> {
